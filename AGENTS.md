...
- Health suppression hierarchy: audiobook playback suppresses ALL health nudges; restless-night shield suppresses water and walk until first event ends or 10:00; water never renders on commute maps; maps retain max two health pills, while calendar-empty and wind-down cards show up to four built-in health pills and four custom reminder pills per row with `+N` overflow; 2x2 renders zero health UI; health elements never inherit pending alpha or stale grey.
